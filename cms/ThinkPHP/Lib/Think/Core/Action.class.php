    ...
    protected function display($templateFile='',$charset='',$contentType='text/html')
    {
        if(false === $templateFile) {
			...
			if(!file_exists($templateFile)){
				$templateFile = str_replace('/'.C('DEFAULT_THEME').'/', '/default/', $templateFile);
			}
